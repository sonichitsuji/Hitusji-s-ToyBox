#> sorcery:spells/niente/ricochet_orb/hit
# ヒットしたときの処理
...
# ダメージの関数に渡す引数
data modify storage hitsuji:sorcery Damage set value "5"
data modify storage hitsuji:sorcery Damage_type set value "h_core:weak"
data modify storage hitsuji:sorcery DeathMsg set value "撃たれた"
