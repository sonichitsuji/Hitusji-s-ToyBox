#> sorcery:spells/niente/chase_shot/cast
# 魔法発動
# @within sorcery:mains/detect_sorcery

# スコアセット
scoreboard players set @s H.CoolTime 5
...
execute as @n[tag=H.Magic] at @s run function sorcery:spells/niente/chase_shot/move with storage hitsuji:sorcery