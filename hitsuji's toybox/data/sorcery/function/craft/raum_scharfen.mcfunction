#> sorcery:craft/weltraum
# アイテム作成
# @within sorcery:magic_craft/main

# アイテムどーぞ
loot spawn ~ ~ ~ loot sorcery:item/weltraum

# 効果音
playsound minecraft:entity.player.levelup master @a ~ ~ ~ 1 1.8

# 演出
particle dust{color:[1.0,1.0,1.0],scale:1} ~ ~5 ~ 1 1 1 0 300 force @a
particle dust{color:[0.0,1.0,1.0],scale:1} ~ ~ ~ 0 2 0 0 300 force @a
