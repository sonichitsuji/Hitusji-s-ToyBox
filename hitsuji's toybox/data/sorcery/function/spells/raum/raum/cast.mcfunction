...
# パーティクル表示
execute as @n[tag=H.Launch] at @s run particle dust{color:[0.3,1.0,1.0],scale:1.7} ~ ~ ~ 1 1 1 0 60 force
...
execute as @n[tag=H.Launch] at @s run execute as @s at @s if entity @e[tag=H.hit,sort=nearest,limit=1] at @s run function sorcery:spells/raum/weltraum/hit
